...
class EstadoConversacion(models.Model):
    estado_conversacion_id = models.AutoField(primary_key=True)
    cliente = models.ForeignKey(Cliente, on_delete=models.SET_NULL, null=True, blank=True)  # Campo faltante
    tipo = models.CharField(max_length=50)  # Campo faltante
    paso_actual = models.CharField(max_length=50)  # Campo faltante
    datos_reserva = models.JSONField(default=dict)  # Campo faltante
